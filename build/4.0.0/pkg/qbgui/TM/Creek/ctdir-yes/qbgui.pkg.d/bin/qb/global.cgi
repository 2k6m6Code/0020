...
%gMODEHASH_v2=(
            ...
            'WRR_LATENCY'        =>'Bonding By Latency',
            'BTK_EQUALIZE'       =>'Bandwidth Measure WRR By Packet', 
            'BSWLT'              =>'Bidirectional Sensitive Weighted Leasted Traffic',
            'FRTT'               =>'Fastest ISP Response Time',
            'WLT_EQUALIZE'       =>'Weighted Least Traffic By Packet', 
            'FAST'               =>'Fastest Way By Destination',
...
%gL7PROTOCOLHASH=(
            ...
            'fasttrack'            =>'FastTrack - P2P filesharing(Kazaa,Grokster,Morpheus)', 
            ...
            'gnutella'             =>'Gnutella - P2P filesharing(Foxy,Mxie,ezPeer)', 
           ...
           # 'halflife2-deathmatch'=>'Half-Life 2 Deathmatch', 
            ...
            'http_rtsp'            =>'RTSP tunneled within HTTP', 
           ...
           # 'msn-filetransfer'     =>'MSN Messenger file transfers', 
            ...
            'napster'              =>'Napster - P2P filesharing(WinMX,Winny,Maze)',
           ...
           #'quake-halflife'       =>'HL1 games(HL1,Quake2/3/World,Counterstrike1.6)',
            ...
            'http_dap'             =>'HTTP by Download Accelerator Plus',
            'http_freshdownload'   =>'HTTP by Fresh Download',
            'http_itunes'          =>'HTTP - iTunes (Apple music program)', 
            ...
            'snmp_mon'             =>'SNMP Monitoring', 
            'snmp_trap'            =>'SNMP Traps', 
            'gtalk'                =>'Google Talk - VoIP group communications software', 
            'gtalk2'               =>'Google Talk - VoIP group communications software', 
            'gtalk_vista'          =>'Google Talk for Vista- VoIP group communications software', 
            'gtalk_file'           =>'Google Talk file transfers', 
            'gtalk_file_1'         =>'Google Talk file transfers', 
            'pplive'               =>'PPLive - Chinese P2P streaming video', 
            'ppstream'             =>'PPStream - Chinese P2P streaming video', 
            'qqlive'               =>'QQLive - Chinese P2P streaming video', 
            'qqlive2'              =>'QQLive - Chinese P2P streaming video', 
            'uusee'                =>'UUSee - Chinese P2P streaming video', 
            'gadu_gadu'            =>'Gadu-Gadu - an instant messenger protocol', 
            'thunder5_tcp'         =>'Thunder5 - P2P filesharing',
            'thunder5_see'         =>'Thunder5 - P2P filesharing',
            'softether'            =>'Softether - Softether VPN tool', 
            'clubbox'              =>'Clubbox - P2P filesharing',
            'youtube'              =>'Youtube - Youtube over HTTP' 
);
%gL7FILEHASH=(
...
%gL7VOICEHASH=(
            ...
            'httpvideo'            =>'HTTP - Video over HTTP', 
            'http_itunes'          =>'HTTP - iTunes (Apple music program)',
            'quicktime'            =>'Quicktime - Quicktime over HTTP', 
            'youtube'              =>'Youtube - Youtube over HTTP' 
);
%gL7OTHERHASH=(
            'bgp'                  =>'BGP - Border Gateway Protocol',
